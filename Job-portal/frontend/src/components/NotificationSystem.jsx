    ...
    useEffect(() => {
        const interval = setInterval(() => {
            const mockNotifications = [
                { id: Date.now(), type: 'job_match', title: 'New Job Match!', message: 'Frontend Developer at Google matches your profile', time: new Date(), read: false },
                ...
                { id: Date.now() + 2, type: 'interview', title: 'Interview Scheduled', message: 'Interview scheduled for tomorrow at 2 PM', time: new Date(), read: false }
            ];
