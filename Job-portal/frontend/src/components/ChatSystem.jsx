...
const ChatSystem = () => {
    ...
    const mockMessages = [
        { id: 1, sender: 'recruiter', text: 'Hi! I saw your application for the Frontend Developer position.', time: '10:30 AM', avatar: 'https://picsum.photos/40/40?random=1' },
        { id: 2, sender: 'user', text: 'Hello! Yes, I\'m very interested in the position.', time: '10:32 AM' },
        { id: 3, sender: 'recruiter', text: 'Great! Could you tell me about your React experience?', time: '10:33 AM', avatar: 'https://picsum.photos/40/40?random=1' },
        { id: 4, sender: 'user', text: 'I have 3+ years of React experience, including Redux, hooks, and testing.', time: '10:35 AM' }
    ];
        ...
        if (newMessage.trim()) {
            ...
            setTimeout(() => {
                ...
                const recruiterResponse = {
                    id: Date.now() + 1,
                    sender: 'recruiter',
                    text: 'Thanks for the information! I\'ll review your profile and get back to you soon.',
                    time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
